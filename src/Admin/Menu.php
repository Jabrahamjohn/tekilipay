...
class Menu
{
    ...
    { ?>
<div class="wrap">
    <h1>About Lipa Na Mpesa for WooCommerce</h1>
    ...
    <article>
        ...
        <div style="padding-left: 20px;">
            <li><a href="https://github.com/jabrahamjohn">This Plugin's Github Repo</a></li>
            <!--
    ...
    <h3>Contact</h3>
    <h4>Get in touch with us either via email (<a href="mailto:ajnetworkskenya@gmail.com">ajnetworkskenya@gmail.com</a>) or via phone(<a
            href="tel:+254758238617">+254758238617</a>)</h4>

    <img src="<?php echo plugins_url("./assets/wcmpesa.png"); ?>" width="100px">
</div>
<?php
    }
...
<div class="wrap">
    ...
    <article>
        ...
        <ol>
            ...
            <li>
                Enter the username of a user with the Business Manager role(use the one created above if using Store
                Number)
            </li>
            ...
            <li>
                The online passkey is sent to the email used to on daraja if not received, write to <a
                    href="mailto:apisupport@safaricom.co.ke">apisupport@safaricom.co.ke</a> and request
                for the same.
            </li>
        </ol>
        </p>
    ...
    <article>
        ...
        <p>
            ...
            <?php echo '<ol>
                        <li>Validation URL: <a href="' . home_url('wc-api/lipwa?action=validate&sign=' . $mpesa->signature) . '">' . home_url('wc-api/lipwa?action=validate&sign=' . $mpesa->signature) . '</a></li>
                        <li>Confirmation URL: <a href="' . home_url('wc-api/lipwa?action=confirm&sign=' . $mpesa->signature) . '">' . home_url('wc-api/lipwa?action=confirm&sign=' . $mpesa->signature) . '</a></li>
                        </ol>'; ?>
        </p>
    </article>
    ...
    <article>
        <p>
            On going live on Daraja you will receive an email from Safaricom with production URLs.
        </p>
        <p>
    ...
    <h3>Contact</h3>
    <h4>Incase you are unable to do this on your own, you can get in touch with us either via email (<a
            href="mailto:info@ajnetworkkenya.me">ajnetworkskenya</a>) or via phone(<a href="tel:+254758238617">+254758238617</a>)
    </h4>
