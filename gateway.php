            ...
            public function validate_payment($order_id)
            {
                if (wc_get_order($order_id)) {
                    ...
                    <section class="woocommerce-order-details" id="resend_stk">
                        ...
                        <p class="checking" id="mpesa_receipt"></p>
                                ...
                                <tr class="woocommerce-table__line-item order_item">
                                    <td class="woocommerce-table__product-name product-name">
                                        <form action="' . home_url("wc-api/lipwa?action=request") . '" method="POST" id="renitiate-mpesa-form">
                                            ...
                                            <button id="renitiate-mpesa-button" class="button alt" type="submit">' . ($this->settings['resend'] ?? 'Resend STK Push') . '</button> <br>
                                            <a href='.home_url('/shop').' style="background-color: #4CAF50; color: white; padding: 10px 20px; border: none; border-radius: 5px; text-decoration: none; display: inline-block;">CONFIRM PAYMENT</a>
                                        </form>
                                    </td>
                                </tr>
                            </tbody>
                                ...
                                <thead>
                                    <tr>
                                        <th class="woocommerce-table__product-name product-name">
                                            ' . __("That didn't work? Pay Manually Via M-PESA  and Click Confirm Above", "woocommerce") . '
                                        </th>'
